...
np.savez('Chickenpox_losses.npz', train=np.array(train_losses), val=np.array(val_losses))
...
ax_ts.set_title(f'Chickenpox Time Series (t+{horizon})')
ax_ts.set_xlabel('Time step')
ax_ts.set_ylabel('Total Infections')
...
ax_sc.set_title('Chickenpox Predicted vs. Actual')
ax_sc.set_xlabel('Actual total infections')
ax_sc.set_ylabel('Predicted total infections')

plt.tight_layout()
plt.savefig(f'Chickenpox_forecast_performance_h{horizon}_GConv.pdf')
plt.close()
